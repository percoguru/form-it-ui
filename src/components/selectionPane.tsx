...
function SelectionPane() {
    ...
    return (
        <Grid container xs={12} className={classes.sidePane}>
            <Grid item xs={12}>
                <TextBox/>
                <Button variant="contained" color="primary" onClick={() => addComponent('TextBox')} id = 'TextBox'>
                    Add Text Field
                </Button>
            </Grid>
            <Grid item xs={12}>
                <CheckBox/>
                <Button variant="contained" color="primary" onClick={() => addComponent('CheckBox')} id = 'CheckBox'>
                    Add CheckBox
                </Button>
            </Grid>
        </Grid >
